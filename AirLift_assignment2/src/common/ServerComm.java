...
public class ServerComm
{
   ...
   */
   ...
   public ServerComm (int portNumb, ServerSocket lSocket)
   {
     ...
     /**
   *  Instanciação de um canal de comunicação (forma 3).
   *
   *    @param portNumb número do port de escuta do servidor
   *    @param socketTimeout tempo até haver timeout
   */

  public ServerComm (int portNumb, int socketTimeout)
  {
     serverPortNumb = portNumb;
