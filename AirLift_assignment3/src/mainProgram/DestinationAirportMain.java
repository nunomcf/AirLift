...
public class DestinationAirportMain {
	...
	public static void main(String[] args) {
		String regionName = Parameters.destinationAirportNameEntry;
		...
		try
		{ sharedRegionInt = UnicastRemoteObject.exportObject((Remote) sharedRegion, Parameters.destinationAirportPort);
		}
		catch (RemoteException e)
