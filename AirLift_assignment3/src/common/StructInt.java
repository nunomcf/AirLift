...
/**
 * Auxiliar structure used to return a State and int. 
 */
public class StructInt implements Serializable{
    ...
    /**
     * StructInt instantiation
     * 
     * @param state entity's state
     * @param arg integer value 
     */
    public StructInt(States state, int arg) {
        this.state = state;
        this.arg = arg;
    }
