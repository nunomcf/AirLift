...
public class ServerRegisterRemoteObject {
	...
	public static void main(String[] args) {
		...
		int listeningPort = Parameters.serverRegistryPort; /* it should be set accordingly in each case */
		...
		String nameEntry = Parameters.registryNameEntry;
		...
		while (regEngine.getRunningStatus()) {
			try {
